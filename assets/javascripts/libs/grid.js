		...
		update : function( $item ) {
			...
			if(this.$item.children( 'a' ).data('type')=='work'){
				...
				if(this.$item.children( 'a' ).data('type-detail')=='dialexa'){
					...
					this.$content_col1 = $('<div class="col-1_3"><div class="head">Tested a .NET Application</div><div class="details">&#149; &nbsp;Performed Unit Tests in C# using NCover, achieved above 95% code coverage for assigned modules.<br/><br/>&#149;&nbsp;Executed and documented manual tests.</div></div>' );
